...
<script setup>
// This file is an override of CRM's AppSidebar via Visit Management's src overrides.
// It preserves CRM behavior and only injects two links: Visits and Weekly Schedule.
...
const links = [
  ...
  // Visit Management additions via override only (no CRM core edits)
  {
    label: 'Visits',
    icon: PhoneIcon,
    to: 'Visits',

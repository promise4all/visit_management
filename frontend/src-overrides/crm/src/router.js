...
// NOTE: This file overrides CRM's router to add Visit Management routes while preserving existing ones.
const routes = [
  {
    path: '/',
    name: 'Home',
  ...
  {
    alias: '/weekly-schedule',
    path: '/weekly-schedule',
    name: 'WeeklySchedule',
    component: () => import('@/pages/WeeklySchedule.vue'),
  },
  {
    path: '/welcome',
    name: 'Welcome',
